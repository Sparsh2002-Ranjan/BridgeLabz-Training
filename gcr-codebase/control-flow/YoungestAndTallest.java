...
public class YoungestAndTallest {
    public static void main(String[] args) {
        ...
        System.out.print("Enter Amar's age and then height");
        int age1 = sc.nextInt();
        int height1 = sc.nextInt();
        System.out.print("Enter Akbar's age and then height");
        int age2 = sc.nextInt();
        int height2 = sc.nextInt();
        System.out.print("Enter Anthony's age and then height");
        int age3 = sc.nextInt();
